...
enum e_fitness_type
{
    ...
    FAULT_RATE_MIN_LENGTH_MAX_PROPAGATION,
    FAULT_RATE_MIN_LENGTH_WITH_NEIGHBOURS,
    FAULT_RATE_MIN_LENGTH_MAX_PROPAGATION_WITH_NEIGHBOURS,
    MAX_FITNESS_TYPE
};
...
enum e_cut_type
{
    ...
    CUT_END_DOUBLE_RANDOM,
    CUT_END_SINGLE_RANDOM,
    MAX_CUT_TYPE
};
...
enum config_bool
{
    ...
    CONFIG_ALWAYS_TRANSFER_THE_BEST,
...
enum config_float
{
    ...
    CONFIG_MIN_MUTATION_RATE,
    CONFIG_MAX_MUTATION_RATE,
    CONFIG_CUT_END_EXPONENT,
    CONFIG_MAX_FLOAT,
};
